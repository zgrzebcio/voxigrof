...
/* voxiGrof — variants (0.794)
   ...
   The bar: five slots above the vitals holding the held block's variants, the default in the middle
   (VARIANT_POS). A block with fewer than five leaves the rest empty. Hold R and scroll, or hold D-pad
...
const BLOCK_VARIANTS = {
  [B.STONE]:        [{ id: B.STONE_BRICK, name: 'brick' }, { id: B.MOSSY_STONE_BRICK, name: 'mossy brick' },
                     { id: B.CRACKED_STONE_BRICK, name: 'cracked brick' }],
  [B.COBBLE]:       [{ id: B.MOSSY_COBBLE, name: 'mossy' }],
  [B.SULFUR_BLOCK]: [{ id: B.SULFUR_BRICKS, name: 'brick' }],
  [B.GRANITE]:      [{ id: B.GRANITE_BRICKS, name: 'brick' }],
  [B.MARBLE]:       [{ id: B.MARBLE_BRICKS, name: 'brick' }],
  [B.LIMESTONE]:    [{ id: B.LIMESTONE_BRICKS, name: 'brick' }],
...
const _clusterBeds = (gem) => [['stone', 1], ['granite', 2], ['marble', 3], ['limestone', 4]]
