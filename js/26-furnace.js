...
/* The smelting book (0.775). time: seconds per item, xp: per item, banked until the output is taken.
   Raw ore takes 8 s, ground powder 6 s, everything else 5 s. cat is the book tab. */
const SMELT_RECIPES = [
  { in: ITEM.RAW_IRON,      out: ITEM.IRON_INGOT,    time: 8, xp: 4, cat: 'metals' },
  { in: ITEM.RAW_COPPER,    out: ITEM.COPPER_INGOT,  time: 8, xp: 3, cat: 'metals' },
  { in: ITEM.RAW_TIN,       out: ITEM.TIN_INGOT,     time: 8, xp: 3, cat: 'metals' },
  { in: ITEM.RAW_GOLD,      out: ITEM.GOLD_INGOT,    time: 8, xp: 6, cat: 'metals' },
  // ground ore smelts one to one (0.773): a mortar doubles the ingots, so each one pays less
  { in: ITEM.IRON_POWDER,   out: ITEM.IRON_INGOT,    time: 6, xp: 2, cat: 'metals' },
  { in: ITEM.COPPER_POWDER, out: ITEM.COPPER_INGOT,  time: 6, xp: 2, cat: 'metals' },
  { in: ITEM.TIN_POWDER,    out: ITEM.TIN_INGOT,     time: 6, xp: 2, cat: 'metals' },
  { in: ITEM.GOLD_POWDER,   out: ITEM.GOLD_INGOT,    time: 6, xp: 3, cat: 'metals' },
  { in: ITEM.BRONZE_POWDER, out: ITEM.BRONZE_INGOT,  time: 6, xp: 5, cat: 'metals' },   // 0.774
  { in: B.SAND,             out: B.GLASS,            time: 5, xp: 1, cat: 'blocks' },
  { in: B.COBBLE,           out: B.STONE,            time: 5, xp: 1, cat: 'blocks' },
  { in: B.LOG,              out: ITEM.CHARCOAL,      time: 5, xp: 2, cat: 'materials' },
  { in: B.BIRCH_LOG,        out: ITEM.CHARCOAL,      time: 5, xp: 2, cat: 'materials' },
  ...
  { in: ITEM.ROTTEN_FLESH,  out: ITEM.LEATHER,       time: 5, xp: 2, cat: 'materials' },
  { in: ITEM.FLOUR,         out: ITEM.BREAD,         time: 5, xp: 2, cat: 'food' },
  { in: ITEM.MUTTON,        out: ITEM.COOKED_MUTTON, time: 5, xp: 2, cat: 'food' },
  { in: ITEM.BEEF,          out: ITEM.COOKED_BEEF,   time: 5, xp: 2, cat: 'food' },
  { in: ITEM.PUMPKIN_PIE,   out: ITEM.COOKED_PUMPKIN_PIE, time: 5, xp: 3, cat: 'food' },   // bake the raw pie (0.761)
];
