...
const SWAP_KEYS = [
  ...
  '_prevMining', '_prevBreak', '_prevPlace', '_prevYaw', '_prevPitch', '_heldId', '_heldVar', '_nockId',
...
function joinPlayer(name) {
  ...
  g._prevYaw = 0; g._prevPitch = 0; g._heldId = undefined; g._heldVar = 0; g._nockId = undefined;
